...
public class UpdateRequirement {
	...
	public static void main(String[] args) {
		String sourceRequirementURL = "https://doors-ng-uat.jpl.nasa.gov:9443/rm/resources/_g0a4AWrfEeafeva6bOHaJA";		// req 8
		String targetRequirementURL = "https://doors-ng-uat.jpl.nasa.gov:9443/rm/resources/_73RvcWrhEeafeva6bOHaJA";		// req 9
		...
		try {
			...
			addCustomLinkToExistingRequirement(sourceRequirementURL, targetRequirementURL, customLinkURL);
