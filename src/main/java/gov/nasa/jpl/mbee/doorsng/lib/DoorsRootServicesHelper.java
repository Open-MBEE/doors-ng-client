 ...
 * Doors rootservices document
 *
 * This class is not currently thread safe.
 */
public class DoorsRootServicesHelper {
	 ...
	 */
	public DoorsRootServicesHelper (String url, String catalogDomain) throws RootServicesException {
		this.baseUrl = url;
	...
	public DoorsOAuthClient initOAuthClient(String consumerKey, String secret) {
		return new DoorsOAuthClient (
								requestTokenUrl,
	...
	public DoorsFormAuthClient initFormClient(String userid, String password)
	{
		return new DoorsFormAuthClient(baseUrl, userid, password);
	 ...
	 */
	public DoorsFormAuthClient initFormClient(String userid, String password, String authUrl)
	{
		return new DoorsFormAuthClient(baseUrl, authUrl, userid, password);
