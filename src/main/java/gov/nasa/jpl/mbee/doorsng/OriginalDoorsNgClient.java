...
public class OriginalDoorsNgClient {
	...
	private static final Logger logger = Logger.getLogger(OriginalDoorsNgClient.class.getName());
...
//				        OSLCConstants.RM_REQUIREMENT_COLLECTION_TYPE, client, "Test Plan Collection");
