 ...
 *
 */
public class OriginalDoorsNgClient {

    private static final Logger logger                           = Logger
            .getLogger(OriginalDoorsNgClient.class.getName());
    ...
    public static void main(String[] args) throws ParseException {
        ...
        try {
            ...
            // client.lookupServiceProviderUrl(catalogUrl, projectArea);
            //
            ...
            // ResourceShape featureInstanceShape =
            ...
            //
            // ResourceShape collectionInstanceShape =
            // RmUtil.lookupRequirementsInstanceShapes(
            // serviceProviderUrl, OSLCConstants.OSLC_RM_V2,
            // OSLCConstants.RM_REQUIREMENT_COLLECTION_TYPE, client,
            // "Requirement Collection");
            // OSLCConstants.RM_REQUIREMENT_COLLECTION_TYPE, client, "Test Plan
            // Collection");

            // We need to use Resource shapes to properly handle date attributes
            // attributes,
            // so they aren't interpreted as dateTime.
            // The following 4 lines will enable the logic to properly handle
            // date attributes
            ...
            if (req01URL == null || req02URL == null || req03URL == null || req04URL == null || reqcoll01URL == null) {
            ...
            for (QName qname : requestExtProperties.keySet()) {
                Property attr = featureInstanceShape
                        .getProperty(new URI(qname.getNamespaceURI() + qname.getLocalPart()));
                String name = null;
                if (attr != null) {
                    name = attr.getTitle();
                    if (name != null) {
            ...
            Object changedPrimaryText = (Object) requirement.getExtendedProperties()
            ...
            if (changedPrimaryText != null) {
                primarytextString = changedPrimaryText.toString(); // Handle the
                // case where
                // Primary
                // Text is
                // returned
            ...
            // SCENARIO 02 Do a query for type= Requirements and for it folder
            ...
            // SCENARIO 06 Do a query for it container folder and for the link
            // that is implemented
            queryParams = new OslcQueryParameters();
